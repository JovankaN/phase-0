...
//Definitely the terah.children's object property , i didn't know  the syntax , so pretty much you have to set the object to a "hash " structure looks like , but when i tried to use the "hash rocket", it would not pass so i had to use ":".
// How difficult was it to add and delete properties outside of the object itself?
//Not too bad once i realize the syntax is Object.property to reference the property outside the object
//What did you learn about manipulating objects in this challenge?
// The delete method...i tried to write it like delete. instead delete(empty space), then how to nest object and property data in the property of another object...etc.
