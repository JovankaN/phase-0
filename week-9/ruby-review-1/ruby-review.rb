...
# I worked on this challenge [ with:Lauren G Reid ].
...
# we didn't find any built in methods for this challenge nor refactored if statements because we both felt like it was readable enough,
 class Car
...
# - How to pass data between methods, solidified my understanding of instance variables, we reviewed attr_accessors  reader and writer as well.
# What is still confusing to you about Ruby?
# - Bit confusing about the interaction between objects ..i am sure it gets much more complex than this
