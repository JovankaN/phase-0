...
puts "--- printing name ----"
sleep 0.8
p instance_of_profile.name  #what_is_name

puts "--- printing occupation ----"
sleep 0.8
p instance_of_profile.occupation  #what_is_occupation
...
instance_of_profile.name = "Taylor"  #change_my_name = "Taylor"
instance_of_profile.occupation = "Rare Coins Trader"  #change_my_occupation = "Rare Coins Trader"
